...
import logo from "../../../public/assets/Brand_logo2[1].png";  
...
const AboutFooter = () => {  
  return (  
    <footer className="bg-gradient-to-r from-[#000000] to-[#0A0710] text-white py-12">  
      ...
      <div className="flex flex-col p-8 md:flex-row mt-8 md:mt-12 gap-8 justify-between items-center w-full bg-black text-white">  
