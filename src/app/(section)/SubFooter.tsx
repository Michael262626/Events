...
const SubFooter = () => {  
  return (  
    <div className="bg-black text-white py-8 md:py-16 flex justify-center items-center min-h-screen">  
      <div className="border p-6 md:p-12 justify-center items-center w-[90%] md:w-[85%] rounded-2xl border-gray-300 bg-gradient-to-r from-black to-gray-900">  
        <div className="container mx-auto text-center">  
          <div className="flex flex-col lg:flex-row justify-between items-center mb-8 md:mb-12">  
            {/* Left Section */}  
