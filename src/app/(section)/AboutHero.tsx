...
const AboutHero =()=>{
    return(
        <div className="relative flex flex-col">
            ...
            <h2 className="absolute text-white text-6xl font-bold">About us</h2>
            <h2 className="absolute text-2xl mt-36 font-bold">Home / <span className="text-gray-400">About us</span></h2>
            </div>
