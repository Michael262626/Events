    ...
    <section className="bg-black text-white py-12">  
      <div className="max-w-7xl mx-auto px-6">  
        ...
        <div className="mb-12 flex flex-col md:flex-row md:justify-between md:items-start gap-6">  
          ...
          <p className="md:w-1/2 text-right mt-4 text-gray-400 max-w text-lg md:text-xl">  
            Immerse in mesmerizing performances, vibrant <br /> soundscapes, and  
            interactive art at our music <br /> festival atmosphere like no <br /> other, where unforgettable moments.  
          </p>  
        </div>  
