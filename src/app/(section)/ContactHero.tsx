...
const AboutHero =()=>{
    return(
        <div className="relative flex flex-col">
            ...
            <h2 className="absolute text-white text-6xl font-bold">Contact us</h2>
            <h2 className="absolute text-2xl mt-36 font-bold">Home / <span className="text-gray-400">Contact us</span></h2>
            </div>
            
            <div className="mt-8 p-28 flex flex-col md:flex-row items-center md:justify-between">
            <div className="text-center md:text-left">
                <h1 className="text-pink-500 text-6xl md:text-5xl font-bold">Eventiva</h1>
